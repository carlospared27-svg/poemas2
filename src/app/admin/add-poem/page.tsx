...
const AdminAddPoemPage = () => {
    ...
    React.useEffect(() => {
        // Redirige si el usuario no es admin una vez que el estado de auth ha cargado.
        if (!loading && !isAdmin) {
            toast({
    ...
    // Muestra el loader mientras se verifica el estado de autenticación o si el usuario no es admin.
    if (loading || !isAdmin) {
        return (
            <MainLayout>
